...
public class ChatActivity extends Activity implements View.OnClickListener{
     ...
     * 消息
     */
    private ArrayList<ChatMsgBean> msgs=new ArrayList<>();
    ...
    private void initMsgAndMsgListener(){
         ...
         * 获取表中的全部记录
         */
        msgs=dbManager.getBeans(new ChatMsgBean(),"friend_msg",null,null);
    ...
    private void sendMsg(String msg){
        ...
        Chat chat=chatManager.createChat("test5@vibexie-server", null);
